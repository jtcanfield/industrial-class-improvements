...
class Events extends Component {
  ...
  render() {
    ...
    const iframelink = `https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Ftriangleiww%2Fevents%2F&tabs=events&width=${this.state.width}&height=800&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=false&appId=196378587576073`;
    let iframestyles = {
