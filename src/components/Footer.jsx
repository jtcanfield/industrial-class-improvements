...
const Footer = () => (
  <div className="Footer" itemScope itemType="http://schema.org/WPFooter">
    <p>
      ...
      <a href="https://www.facebook.com/triangleiww/" target="_blank" rel="noopener noreferrer">
    ...
    <p>{'Check out our IWOC blog: '}
      <a href="https://raleighdurhamiwoc.wordpress.com/" target="_blank" rel="noopener noreferrer">
