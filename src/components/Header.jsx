    ...
    return (
      <div className="Header" itemScope itemType="http://schema.org/WPHeader">
        <div className="header_logo_title">
          ...
          <div className="curveholder">
            <svg
              ...
              width="1200.000000pt"
              height="129.000000pt"
              viewBox="0 0 1200.000000 129.000000"
        ...
        <div onClick={this.click} className={arrowclasses}>
          <span alt="open menu" className={actualarrow} />
          <div onClick={this.click} className={hitbox} />
        </div>
        <div role="navigation" itemScope itemType="http://schema.org/SiteNavigationElement" onClick={this.click} className={modalclasses}>
          ...
          <a
            href="https://www.paypal.me/rdiwwgmb"
            target="_blank"
        ...
        <div onClick={this.click} onTouchStart={this.click} className={openmodalbackground} />
      </div>
    );
  }
}
